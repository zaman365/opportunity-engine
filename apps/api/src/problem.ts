...
const TITLES: Record<ErrorCode, string> = {
  ...
  OFFER_NOT_ELIGIBLE: 'No approved scope covers this case',
  OFFER_PREREQUISITES_UNMET: 'Prerequisites for this scope are not recorded',
  OFFER_DRAFT_EXISTS: 'This scope is already drafted for this case',
