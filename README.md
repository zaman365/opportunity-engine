...
implemented** (MF-LINK-01, MF-ASSET-01). Nothing is deployed. Live capture, cloud resources,
payments and every integration remain unconfigured and fail closed. Read
...
packages/domain      Scoring, money, state machine, URL policy, detectors
