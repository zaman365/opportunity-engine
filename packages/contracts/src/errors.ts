...
export const ERROR_CODES = {
  ...
  OFFER_NOT_ELIGIBLE: { status: 422, retryable: false },
  OFFER_PREREQUISITES_UNMET: { status: 422, retryable: false },
  OFFER_DRAFT_EXISTS: { status: 409, retryable: false },
  DELIVERY_CAPACITY_REACHED: { status: 409, retryable: false },
